...
jQuery(document).ready(function() {
	// initiate googlemaps					
    jQuery('#map').goMap({ address: '600, Krishna Business Center, Behind Sai Service Petrol Pump, J.M. Road, Deccan, Pune, Maharashtra 411004',
	    	zoom: 16,
	    	navigationControl: true, 
	    	maptype: 'TERRAIN',
	    	draggable: false, zoomControl: false, scrollwheel: false, disableDragging: true,
	    	markers: [
	    		{ 'address' : '600, Krishna Business Center, Behind Sai Service Petrol Pump, J.M. Road, Deccan, Pune, Maharashtra 411004' }
	    	],
